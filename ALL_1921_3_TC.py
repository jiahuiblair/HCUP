...
for day in PRDay_list:
    ...
    filename = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_Individual\Prediction_summary_{day}.csv"
    outcome_df.to_csv(filename, index=False)

    # Save the DataFrame to a CSV file
    filename1 = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_Individual\Prediction_data_output_{day}.csv"
