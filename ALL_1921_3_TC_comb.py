...
binary_columns = ['KID','C9100','C9102','Z006','AWEEKEND', 'ELECTIVE', 'FEMALE', 'HCUP_ED',
                       'I10_INJURY','PCLASS_ORPROC']# Exclude the C9101 achieved remission
...
for day in PRDay_list:
    ...
    filename = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_comb\Prediction_summary_BreakPLOSD_{day}.csv"
    outcome_df.to_csv(filename, index=False)

    # Save the DataFrame to a CSV file
    filename1 = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_comb\Prediction_data_output_BreakPLOSD_{day}.csv"
