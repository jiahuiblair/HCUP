...
binary_columns = ['KID','C9100','C9102'] #, 'Area' Exclude the C9101 achieved remission
...
for day in PRDay_list:
    ...
    for outcome in Response_column:
        ...
        model_data = model_data[model_data[outcome] != '']
        ...
        rf_col_name = f"Pred_{outcome}"
        print(rf_col_name)
        # Add predictions as new columns
        model_data[rf_col_name] = y_pred
    ...
    print("Length of selected_features_gb:", len(selected_features_gb))
    print("Length of gb_feature_importances:", len(gb_feature_importances))
    ...
    filename = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_comb\Prediction_summary_BreakPLOSD_Z006_{day}.csv"
    outcome_df.to_csv(filename, index=False)

    # Save the DataFrame to a CSV file
    filename1 = fr"C:\Users\Jiahui\PycharmProjects\NIS\TCprediction_comb\Prediction_data_output_BreakPLOSD_Z006_{day}.csv"
